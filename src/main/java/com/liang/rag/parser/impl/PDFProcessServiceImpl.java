...
public class PDFProcessServiceImpl extends MinerUProcessBaseServiceImpl {
    ...
    public PDFProcessServiceImpl(FileStorageStrategy fileStorageStrategy, KnowledgeDocumentMapper knowledgeDocumentMapper, MineruProperties mineruProperties, DocumentProcessProperties documentProcessProperties, ImageDescriptionService imageDescriptionService, DocumentProcessProducer documentProcessProducer) {
